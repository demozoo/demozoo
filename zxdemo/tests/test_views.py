...
class TestProduction(TestCase):
    ...
    def test_get(self):
        ...
        pondlife.links.create(
            link_class="BaseUrl", parameter="https://example.com/pondlife.zip", is_download_link=True, description="TAP"
        )
...
class TestAuthor(TestCase):
    ...
    def test_get_scener(self):
        Production.objects.get(title="Madrielle").credits.create(nick=self.gasman.primary_nick, category="Code")
...
class TestArticles(TestCase):
    def setUp(self):
        self.article = Article.objects.create(
            ...
            title="An article",
            summary="it's going to be good",
            content="oh actually it wasn't",
        )
