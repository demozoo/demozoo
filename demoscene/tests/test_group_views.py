...
class TestRemoveMember(TestCase):
    ...
    def test_ex_member(self):
        response = self.client.post(
            "/groups/%d/remove_member/%d/" % (self.hooy_program.id, self.gasman.id),
            {
...
class TestRemoveSubgroup(TestCase):
    ...
    def test_post(self):
        response = self.client.post(
            "/groups/%d/remove_subgroup/%d/" % (self.raww_arse.id, self.papaya_dezign.id),
            {
                "yes": "yes",
            },
        )
...
class TestConvertToScener(TestCase):
    ...
    def test_post(self):
        response = self.client.post(
            "/groups/%d/convert_to_scener/" % self.fairlight.id,
            {
                "yes": "yes",
            },
        )
