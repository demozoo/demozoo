...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Production.created_at'
        db.add_column('demoscene_production', 'created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2010, 10, 5, 17, 14, 5, 551636), blank=True), keep_default=False)

        # Adding field 'Production.updated_at'
        db.add_column('demoscene_production', 'updated_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2010, 10, 5, 17, 14, 14, 526121)), keep_default=False)

        # Adding field 'Releaser.created_at'
        db.add_column('demoscene_releaser', 'created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2010, 10, 5, 17, 14, 20, 117301), blank=True), keep_default=False)

        # Adding field 'Releaser.updated_at'
        db.add_column('demoscene_releaser', 'updated_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2010, 10, 5, 17, 14, 22, 21205)), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Production.created_at'
        db.delete_column('demoscene_production', 'created_at')

        # Deleting field 'Production.updated_at'
        db.delete_column('demoscene_production', 'updated_at')

        # Deleting field 'Releaser.created_at'
        db.delete_column('demoscene_releaser', 'created_at')

        # Deleting field 'Releaser.updated_at'
        db.delete_column('demoscene_releaser', 'updated_at')
