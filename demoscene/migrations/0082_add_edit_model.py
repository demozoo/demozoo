...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Edit'
        db.create_table('demoscene_edit', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('action_type', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('focus_content_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='edits', to=orm['contenttypes.ContentType'])),
            ('focus_object_id', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('focus2_content_type', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='edits_as_focus2', null=True, to=orm['contenttypes.ContentType'])),
            ('focus2_object_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True)),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('demoscene', ['Edit'])


    def backwards(self, orm):
        
        # Deleting model 'Edit'
        db.delete_table('demoscene_edit')
