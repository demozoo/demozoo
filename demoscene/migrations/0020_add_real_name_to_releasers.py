...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Releaser.first_name'
        db.add_column('demoscene_releaser', 'first_name', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)

        # Adding field 'Releaser.surname'
        db.add_column('demoscene_releaser', 'surname', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Releaser.first_name'
        db.delete_column('demoscene_releaser', 'first_name')

        # Deleting field 'Releaser.surname'
        db.delete_column('demoscene_releaser', 'surname')
