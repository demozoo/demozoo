...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ProductionLink.is_unresolved_for_screenshotting'
        db.add_column('demoscene_productionlink', 'is_unresolved_for_screenshotting', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ProductionLink.is_unresolved_for_screenshotting'
        db.delete_column('demoscene_productionlink', 'is_unresolved_for_screenshotting')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 12, 23, 22, 58, 262808)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 12, 23, 22, 58, 262667)'}),
