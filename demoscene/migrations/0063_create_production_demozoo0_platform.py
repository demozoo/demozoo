...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ProductionDemozoo0Platform'
        db.create_table('demoscene_productiondemozoo0platform', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('production', self.gf('django.db.models.fields.related.ForeignKey')(related_name='demozoo0_platforms', to=orm['demoscene.Production'])),
            ('platform', self.gf('django.db.models.fields.CharField')(max_length=64)),
        ))
        db.send_create_signal('demoscene', ['ProductionDemozoo0Platform'])


    def backwards(self, orm):
        
        # Deleting model 'ProductionDemozoo0Platform'
        db.delete_table('demoscene_productiondemozoo0platform')
