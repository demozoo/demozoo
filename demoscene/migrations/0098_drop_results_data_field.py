...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ResultsFile.data'
        db.delete_column('demoscene_resultsfile', 'data')

        # Changing field 'ResultsFile.file'
        db.alter_column('demoscene_resultsfile', 'file', self.gf('django.db.models.fields.files.FileField')(max_length=100, blank=True))


    def backwards(self, orm):
        
        # Adding field 'ResultsFile.data'
        db.add_column('demoscene_resultsfile', 'data', self.gf('blob_field.BlobField')(default='x'), keep_default=False)

        # Changing field 'ResultsFile.file'
        db.alter_column('demoscene_resultsfile', 'file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 31, 0, 24, 12, 946909)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 10, 31, 0, 24, 12, 946763)'}),
