...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ResultsFile.encoding'
        db.alter_column('demoscene_resultsfile', 'encoding', self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True))


    def backwards(self, orm):
        
        # Changing field 'ResultsFile.encoding'
        db.alter_column('demoscene_resultsfile', 'encoding', self.gf('django.db.models.fields.CharField')(max_length=32))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 3, 19, 27, 24, 726940)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 3, 19, 27, 24, 726791)'}),
