...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PartySeries.twitter_username'
        db.add_column('demoscene_partyseries', 'twitter_username', self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True), keep_default=False)

        # Adding field 'PartySeries.pouet_party_id'
        db.add_column('demoscene_partyseries', 'pouet_party_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PartySeries.twitter_username'
        db.delete_column('demoscene_partyseries', 'twitter_username')

        # Deleting field 'PartySeries.pouet_party_id'
        db.delete_column('demoscene_partyseries', 'pouet_party_id')
