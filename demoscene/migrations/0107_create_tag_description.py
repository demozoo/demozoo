...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TagDescription'
        db.create_table(u'demoscene_tagdescription', (
            ('tag', self.gf('django.db.models.fields.related.OneToOneField')(related_name='description', unique=True, primary_key=True, to=orm['taggit.Tag'])),
            ('description', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'demoscene', ['TagDescription'])


    def backwards(self, orm):
        # Deleting model 'TagDescription'
        db.delete_table(u'demoscene_tagdescription')
