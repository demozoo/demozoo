...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Production.zxdemo_id'
        db.delete_column('demoscene_production', 'zxdemo_id')

        # Deleting field 'Production.pouet_id'
        db.delete_column('demoscene_production', 'pouet_id')

        # Deleting field 'Production.bitworld_id'
        db.delete_column('demoscene_production', 'bitworld_id')

        # Deleting field 'Production.csdb_id'
        db.delete_column('demoscene_production', 'csdb_id')


    def backwards(self, orm):
        
        # Adding field 'Production.zxdemo_id'
        db.add_column('demoscene_production', 'zxdemo_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Production.pouet_id'
        db.add_column('demoscene_production', 'pouet_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Production.bitworld_id'
        db.add_column('demoscene_production', 'bitworld_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Production.csdb_id'
        db.add_column('demoscene_production', 'csdb_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)
