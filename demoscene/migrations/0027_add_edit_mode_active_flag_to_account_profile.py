...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('demoscene_accountprofile', 'edit_mode_active', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AccountProfile.edit_mode_active'
        db.delete_column('demoscene_accountprofile', 'edit_mode_active')
