...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Releaser.data_source'
        db.add_column('demoscene_releaser', 'data_source', self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True), keep_default=False)

        # Adding field 'Membership.data_source'
        db.add_column('demoscene_membership', 'data_source', self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Releaser.data_source'
        db.delete_column('demoscene_releaser', 'data_source')

        # Deleting field 'Membership.data_source'
        db.delete_column('demoscene_membership', 'data_source')
