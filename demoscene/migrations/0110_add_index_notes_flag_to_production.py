...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Production.include_notes_in_search'
        db.add_column(u'demoscene_production', 'include_notes_in_search',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Production.include_notes_in_search'
        db.delete_column(u'demoscene_production', 'include_notes_in_search')
