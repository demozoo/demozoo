...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Production', fields ['created_at']
        db.create_index('demoscene_production', ['created_at'])

        # Adding index on 'Production', fields ['updated_at']
        db.create_index('demoscene_production', ['updated_at'])


    def backwards(self, orm):
        
        # Removing index on 'Production', fields ['created_at']
        db.delete_index('demoscene_production', ['created_at'])

        # Removing index on 'Production', fields ['updated_at']
        db.delete_index('demoscene_production', ['updated_at'])
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 18, 18, 11, 0, 20999)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 18, 18, 11, 0, 20856)'}),
