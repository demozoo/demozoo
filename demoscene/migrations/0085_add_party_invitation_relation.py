...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field invitations on 'Party'
        db.create_table('demoscene_party_invitations', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('party', models.ForeignKey(orm['demoscene.party'], null=False)),
            ('production', models.ForeignKey(orm['demoscene.production'], null=False))
        ))
        db.create_unique('demoscene_party_invitations', ['party_id', 'production_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field invitations on 'Party'
        db.delete_table('demoscene_party_invitations')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 4, 22, 39, 50, 271644)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 4, 22, 39, 50, 271499)'}),
