...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PartySeriesDemozoo0Reference'
        db.create_table('demoscene_partyseriesdemozoo0reference', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('party_series', self.gf('django.db.models.fields.related.ForeignKey')(related_name='demozoo0_ids', to=orm['demoscene.PartySeries'])),
            ('demozoo0_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal('demoscene', ['PartySeriesDemozoo0Reference'])

        # Deleting field 'PartySeries.demozoo0_id'
        db.delete_column('demoscene_partyseries', 'demozoo0_id')


    def backwards(self, orm):
        
        # Deleting model 'PartySeriesDemozoo0Reference'
        db.delete_table('demoscene_partyseriesdemozoo0reference')

        # Adding field 'PartySeries.demozoo0_id'
        db.add_column('demoscene_partyseries', 'demozoo0_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)
