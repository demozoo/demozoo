...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Releaser.show_first_name'
        db.add_column('demoscene_releaser', 'show_first_name', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True), keep_default=False)

        # Adding field 'Releaser.show_surname'
        db.add_column('demoscene_releaser', 'show_surname', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True), keep_default=False)

        # Adding field 'Releaser.real_name_note'
        db.add_column('demoscene_releaser', 'real_name_note', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Releaser.show_first_name'
        db.delete_column('demoscene_releaser', 'show_first_name')

        # Deleting field 'Releaser.show_surname'
        db.delete_column('demoscene_releaser', 'show_surname')

        # Deleting field 'Releaser.real_name_note'
        db.delete_column('demoscene_releaser', 'real_name_note')
