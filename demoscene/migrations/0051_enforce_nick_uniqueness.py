...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Nick', fields ['name', 'releaser']
        db.create_unique('demoscene_nick', ['name', 'releaser_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Nick', fields ['name', 'releaser']
        db.delete_unique('demoscene_nick', ['name', 'releaser_id'])
