...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'ProductionLink', fields ['production', 'parameter', 'is_download_link', 'link_class']
        db.create_unique('demoscene_productionlink', ['production_id', 'parameter', 'is_download_link', 'link_class'])

        # Adding unique constraint on 'ReleaserExternalLink', fields ['releaser', 'parameter', 'link_class']
        db.create_unique('demoscene_releaserexternallink', ['releaser_id', 'parameter', 'link_class'])

        # Adding unique constraint on 'PartyExternalLink', fields ['party', 'parameter', 'link_class']
        db.create_unique('demoscene_partyexternallink', ['party_id', 'parameter', 'link_class'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'ProductionLink', fields ['production', 'parameter', 'is_download_link', 'link_class']
        db.delete_unique('demoscene_productionlink', ['production_id', 'parameter', 'is_download_link', 'link_class'])

        # Removing unique constraint on 'ReleaserExternalLink', fields ['releaser', 'parameter', 'link_class']
        db.delete_unique('demoscene_releaserexternallink', ['releaser_id', 'parameter', 'link_class'])

        # Removing unique constraint on 'PartyExternalLink', fields ['party', 'parameter', 'link_class']
        db.delete_unique('demoscene_partyexternallink', ['party_id', 'parameter', 'link_class'])
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 21, 0, 18, 53, 875267)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 21, 0, 18, 53, 875127)'}),
        ...
        'demoscene.party': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invitations': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'invitation_parties'", 'symmetrical': 'False', 'to': "orm['demoscene.Production']"}),
