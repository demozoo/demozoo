...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ProductionType.is_demo'
        db.add_column('demoscene_productiontype', 'is_demo', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'ProductionType.is_music'
        db.add_column('demoscene_productiontype', 'is_music', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ProductionType.is_demo'
        db.delete_column('demoscene_productiontype', 'is_demo')

        # Deleting field 'ProductionType.is_music'
        db.delete_column('demoscene_productiontype', 'is_music')
