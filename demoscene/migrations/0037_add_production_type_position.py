...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ProductionType.position'
        db.add_column('demoscene_productiontype', 'position', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ProductionType.position'
        db.delete_column('demoscene_productiontype', 'position')
