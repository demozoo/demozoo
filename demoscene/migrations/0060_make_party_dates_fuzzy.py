...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming field 'Party.start_date'
        db.rename_column('demoscene_party', 'start_date', 'start_date_date')

        # Renaming field 'Party.end_date'
        db.rename_column('demoscene_party', 'end_date', 'end_date_date')

        # Adding field 'Party.start_date_precision'
        db.add_column('demoscene_party', 'start_date_precision', self.gf('django.db.models.fields.CharField')(default='d', max_length=1), keep_default=False)

        # Adding field 'Party.end_date_precision'
        db.add_column('demoscene_party', 'end_date_precision', self.gf('django.db.models.fields.CharField')(default='d', max_length=1), keep_default=False)


    def backwards(self, orm):
        
        # Renaming field 'Party.start_date_date'
        db.rename_column('demoscene_party', 'start_date_date', 'start_date')

        # Deleting field 'Party.start_date_precision'
        db.delete_column('demoscene_party', 'start_date_precision')

        # Renaming field 'Party.end_date_date'
        db.rename_column('demoscene_party', 'end_date_date', 'end_date')

        # Deleting field 'Party.end_date_precision'
        db.delete_column('demoscene_party', 'end_date_precision')
