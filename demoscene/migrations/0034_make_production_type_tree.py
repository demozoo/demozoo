...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ProductionType.path'
        db.add_column('demoscene_productiontype', 'path', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)

        # Adding field 'ProductionType.depth'
        db.add_column('demoscene_productiontype', 'depth', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)

        # Adding field 'ProductionType.numchild'
        db.add_column('demoscene_productiontype', 'numchild', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ProductionType.path'
        db.delete_column('demoscene_productiontype', 'path')

        # Deleting field 'ProductionType.depth'
        db.delete_column('demoscene_productiontype', 'depth')

        # Deleting field 'ProductionType.numchild'
        db.delete_column('demoscene_productiontype', 'numchild')
    ...
    models = {
        ...
        'demoscene.productiontype': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_demo': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
            'is_music': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'numchild': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'path': ('django.db.models.fields.CharField', [], {'max_length': '255'}) # hacked out 'unique' constraint so that migration can proceed
        },
        'demoscene.releaser': {
