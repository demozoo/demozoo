...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PartySeries.notes'
        db.add_column('demoscene_partyseries', 'notes', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PartySeries.notes'
        db.delete_column('demoscene_partyseries', 'notes')
