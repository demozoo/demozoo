...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Platform.photo'
        db.add_column('demoscene_platform', 'photo', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'Platform.photo_width'
        db.add_column('demoscene_platform', 'photo_width', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Platform.photo_height'
        db.add_column('demoscene_platform', 'photo_height', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Platform.thumbnail'
        db.add_column('demoscene_platform', 'thumbnail', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'Platform.thumbnail_width'
        db.add_column('demoscene_platform', 'thumbnail_width', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Platform.thumbnail_height'
        db.add_column('demoscene_platform', 'thumbnail_height', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Platform.photo'
        db.delete_column('demoscene_platform', 'photo')

        # Deleting field 'Platform.photo_width'
        db.delete_column('demoscene_platform', 'photo_width')

        # Deleting field 'Platform.photo_height'
        db.delete_column('demoscene_platform', 'photo_height')

        # Deleting field 'Platform.thumbnail'
        db.delete_column('demoscene_platform', 'thumbnail')

        # Deleting field 'Platform.thumbnail_width'
        db.delete_column('demoscene_platform', 'thumbnail_width')

        # Deleting field 'Platform.thumbnail_height'
        db.delete_column('demoscene_platform', 'thumbnail_height')
