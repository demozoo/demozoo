...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Party.slengpung_party_id'
        db.delete_column('demoscene_party', 'slengpung_party_id')

        # Deleting field 'Party.scene_org_directory'
        db.delete_column('demoscene_party', 'scene_org_directory')

        # Deleting field 'Party.demoparty_net_url_fragment'
        db.delete_column('demoscene_party', 'demoparty_net_url_fragment')

        # Deleting field 'Party.csdb_party_id'
        db.delete_column('demoscene_party', 'csdb_party_id')

        # Deleting field 'Party.breaks_amiga_party_id'
        db.delete_column('demoscene_party', 'breaks_amiga_party_id')

        # Deleting field 'Party.bitworld_party_id'
        db.delete_column('demoscene_party', 'bitworld_party_id')

        # Deleting field 'Party.twitter_username'
        db.delete_column('demoscene_party', 'twitter_username')

        # Deleting field 'Party.zxdemo_party_id'
        db.delete_column('demoscene_party', 'zxdemo_party_id')

        # Deleting field 'Party.pouet_party_id'
        db.delete_column('demoscene_party', 'pouet_party_id')

        # Deleting field 'Party.pouet_party_when'
        db.delete_column('demoscene_party', 'pouet_party_when')


    def backwards(self, orm):
        
        # Adding field 'Party.slengpung_party_id'
        db.add_column('demoscene_party', 'slengpung_party_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Party.scene_org_directory'
        db.add_column('demoscene_party', 'scene_org_directory', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)

        # Adding field 'Party.demoparty_net_url_fragment'
        db.add_column('demoscene_party', 'demoparty_net_url_fragment', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)

        # Adding field 'Party.csdb_party_id'
        db.add_column('demoscene_party', 'csdb_party_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Party.breaks_amiga_party_id'
        db.add_column('demoscene_party', 'breaks_amiga_party_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Party.bitworld_party_id'
        db.add_column('demoscene_party', 'bitworld_party_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Party.twitter_username'
        db.add_column('demoscene_party', 'twitter_username', self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True), keep_default=False)

        # Adding field 'Party.zxdemo_party_id'
        db.add_column('demoscene_party', 'zxdemo_party_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Party.pouet_party_id'
        db.add_column('demoscene_party', 'pouet_party_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Party.pouet_party_when'
        db.add_column('demoscene_party', 'pouet_party_when', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)
