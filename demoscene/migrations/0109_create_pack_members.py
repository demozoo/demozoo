...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PackMember'
        db.create_table(u'demoscene_packmember', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('pack', self.gf('django.db.models.fields.related.ForeignKey')(related_name='pack_members', to=orm['demoscene.Production'])),
            ('member', self.gf('django.db.models.fields.related.ForeignKey')(related_name='packed_in', to=orm['demoscene.Production'])),
            ('position', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'demoscene', ['PackMember'])


    def backwards(self, orm):
        # Deleting model 'PackMember'
        db.delete_table(u'demoscene_packmember')
    ...
    models = {
        ...
        u'demoscene.packmember': {
            'Meta': {'ordering': "['position']", 'object_name': 'PackMember'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'member': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'packed_in'", 'to': u"orm['demoscene.Production']"}),
            'pack': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'pack_members'", 'to': u"orm['demoscene.Production']"}),
