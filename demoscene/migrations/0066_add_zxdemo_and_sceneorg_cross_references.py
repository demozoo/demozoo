...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Production.scene_org_id'
        db.add_column('demoscene_production', 'scene_org_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Production.scene_org_id'
        db.delete_column('demoscene_production', 'scene_org_id')
