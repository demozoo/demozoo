...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Party.geonames_id'
        db.add_column('demoscene_party', 'geonames_id',
                      self.gf('django.db.models.fields.BigIntegerField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'Production.default_screenshot'
        db.alter_column('demoscene_production', 'default_screenshot_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['demoscene.Screenshot']))
        # Adding field 'Releaser.geonames_id'
        db.add_column('demoscene_releaser', 'geonames_id',
                      self.gf('django.db.models.fields.BigIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Party.geonames_id'
        db.delete_column('demoscene_party', 'geonames_id')


        # Changing field 'Production.default_screenshot'
        db.alter_column('demoscene_production', 'default_screenshot_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['demoscene.Screenshot']))
        # Deleting field 'Releaser.geonames_id'
        db.delete_column('demoscene_releaser', 'geonames_id')
