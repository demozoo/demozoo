...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Party.homepage'
        db.add_column('demoscene_party', 'homepage', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Party.homepage'
        db.delete_column('demoscene_party', 'homepage')
