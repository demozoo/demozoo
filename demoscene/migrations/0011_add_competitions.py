...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('demoscene_competition', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('party', self.gf('django.db.models.fields.related.ForeignKey')(related_name='competitions', to=orm['demoscene.Party'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('demoscene', ['Competition'])


    def backwards(self, orm):
        
        # Deleting model 'Competition'
        db.delete_table('demoscene_competition')
