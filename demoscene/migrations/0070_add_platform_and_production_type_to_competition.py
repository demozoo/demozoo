...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Competition.platform'
        db.add_column('demoscene_competition', 'platform', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['demoscene.Platform'], null=True), keep_default=False)

        # Adding field 'Competition.production_type'
        db.add_column('demoscene_competition', 'production_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['demoscene.ProductionType'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Competition.platform'
        db.delete_column('demoscene_competition', 'platform_id')

        # Deleting field 'Competition.production_type'
        db.delete_column('demoscene_competition', 'production_type_id')
