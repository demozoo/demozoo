...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Nick.differentiator'
        db.add_column('demoscene_nick', 'differentiator', self.gf('django.db.models.fields.CharField')(default='', max_length=32, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Nick.differentiator'
        db.delete_column('demoscene_nick', 'differentiator')
