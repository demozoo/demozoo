...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Screenshot.thumbnail'
        db.add_column('demoscene_screenshot', 'thumbnail', self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100), keep_default=False)

        # Adding field 'Screenshot.thumbnail_width'
        db.add_column('demoscene_screenshot', 'thumbnail_width', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Screenshot.thumbnail_height'
        db.add_column('demoscene_screenshot', 'thumbnail_height', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Screenshot.thumbnail'
        db.delete_column('demoscene_screenshot', 'thumbnail')

        # Deleting field 'Screenshot.thumbnail_width'
        db.delete_column('demoscene_screenshot', 'thumbnail_width')

        # Deleting field 'Screenshot.thumbnail_height'
        db.delete_column('demoscene_screenshot', 'thumbnail_height')
