...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        ct, created = orm['contenttypes.ContentType'].objects.get_or_create(
            model='releaser', app_label='demoscene')
        perm, created = orm['auth.permission'].objects.get_or_create(
            content_type=ct, codename='view_releaser_real_names', defaults=dict(name=u'Can view non-public real names'))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 27, 18, 24, 30, 31399)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 27, 18, 24, 30, 31256)'}),
