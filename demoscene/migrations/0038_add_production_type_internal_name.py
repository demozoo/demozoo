...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ProductionType.internal_name'
        db.add_column('demoscene_productiontype', 'internal_name', self.gf('django.db.models.fields.CharField')(default='', max_length=32, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ProductionType.internal_name'
        db.delete_column('demoscene_productiontype', 'internal_name')
