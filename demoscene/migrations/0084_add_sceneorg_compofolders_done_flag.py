...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Party.sceneorg_compofolders_done'
        db.add_column('demoscene_party', 'sceneorg_compofolders_done', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Changing field 'Competition.platform'
        db.alter_column('demoscene_competition', 'platform_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['demoscene.Platform'], null=True, blank=True))

        # Changing field 'Competition.production_type'
        db.alter_column('demoscene_competition', 'production_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['demoscene.ProductionType'], null=True, blank=True))


    def backwards(self, orm):
        
        # Deleting field 'Party.sceneorg_compofolders_done'
        db.delete_column('demoscene_party', 'sceneorg_compofolders_done')

        # Changing field 'Competition.platform'
        db.alter_column('demoscene_competition', 'platform_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['demoscene.Platform'], null=True))

        # Changing field 'Competition.production_type'
        db.alter_column('demoscene_competition', 'production_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['demoscene.ProductionType'], null=True))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 18, 22, 58, 12, 930315)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 18, 22, 58, 12, 930171)'}),
        ...
        'demoscene.productionlink': {
            'Meta': {'object_name': 'ProductionLink'},
            'demozoo0_id': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
