...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('demoscene_membership', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('member', self.gf('django.db.models.fields.related.ForeignKey')(related_name='group_memberships', to=orm['demoscene.Releaser'])),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(related_name='member_memberships', to=orm['demoscene.Releaser'])),
            ('is_current', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True)),
        ))
        db.send_create_signal('demoscene', ['Membership'])
        for releaser in orm.Releaser.objects.select_related('groups'):
            for group in releaser.groups.all():
                membership = orm.Membership(member = releaser, group = group)
                membership.save()
    ...
    def backwards(self, orm):
        ...
        db.delete_table('demoscene_membership')
