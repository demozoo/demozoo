...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Party.location'
        db.add_column('demoscene_party', 'location', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)

        # Adding field 'Party.country_code'
        db.add_column('demoscene_party', 'country_code', self.gf('django.db.models.fields.CharField')(default='', max_length=5, blank=True), keep_default=False)

        # Adding field 'Party.latitude'
        db.add_column('demoscene_party', 'latitude', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'Party.longitude'
        db.add_column('demoscene_party', 'longitude', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'Party.woe_id'
        db.add_column('demoscene_party', 'woe_id', self.gf('django.db.models.fields.BigIntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Party.location'
        db.delete_column('demoscene_party', 'location')

        # Deleting field 'Party.country_code'
        db.delete_column('demoscene_party', 'country_code')

        # Deleting field 'Party.latitude'
        db.delete_column('demoscene_party', 'latitude')

        # Deleting field 'Party.longitude'
        db.delete_column('demoscene_party', 'longitude')

        # Deleting field 'Party.woe_id'
        db.delete_column('demoscene_party', 'woe_id')
