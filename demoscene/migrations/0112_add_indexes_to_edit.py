...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Edit', fields ['focus2_content_type', 'focus2_object_id']
        db.create_index(u'demoscene_edit', ['focus2_content_type_id', 'focus2_object_id'])

        # Adding index on 'Edit', fields ['focus_content_type', 'focus_object_id']
        db.create_index(u'demoscene_edit', ['focus_content_type_id', 'focus_object_id'])


    def backwards(self, orm):
        # Removing index on 'Edit', fields ['focus_content_type', 'focus_object_id']
        db.delete_index(u'demoscene_edit', ['focus_content_type_id', 'focus_object_id'])

        # Removing index on 'Edit', fields ['focus2_content_type', 'focus2_object_id']
        db.delete_index(u'demoscene_edit', ['focus2_content_type_id', 'focus2_object_id'])
