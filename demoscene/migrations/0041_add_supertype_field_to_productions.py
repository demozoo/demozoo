...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Production.supertype'
        db.add_column('demoscene_production', 'supertype', self.gf('django.db.models.fields.CharField')(default='production', max_length=32), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Production.supertype'
        db.delete_column('demoscene_production', 'supertype')
