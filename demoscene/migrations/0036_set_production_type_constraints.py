...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'ProductionType', fields ['path']
        db.create_unique('demoscene_productiontype', ['path'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'ProductionType', fields ['path']
        db.delete_unique('demoscene_productiontype', ['path'])
