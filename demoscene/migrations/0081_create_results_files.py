...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ResultsFile'
        db.create_table('demoscene_resultsfile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('party', self.gf('django.db.models.fields.related.ForeignKey')(related_name='results_files', to=orm['demoscene.Party'])),
            ('filename', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('data', self.gf('blob_field.BlobField')()),
            ('filesize', self.gf('django.db.models.fields.IntegerField')()),
            ('sha1', self.gf('django.db.models.fields.CharField')(max_length=40)),
            ('encoding', self.gf('django.db.models.fields.CharField')(max_length=32)),
        ))
        db.send_create_signal('demoscene', ['ResultsFile'])


    def backwards(self, orm):
        
        # Deleting model 'ResultsFile'
        db.delete_table('demoscene_resultsfile')
