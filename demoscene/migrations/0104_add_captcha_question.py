...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CaptchaQuestion'
        db.create_table(u'demoscene_captchaquestion', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('question', self.gf('django.db.models.fields.TextField')()),
            ('answer', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'demoscene', ['CaptchaQuestion'])


    def backwards(self, orm):
        # Deleting model 'CaptchaQuestion'
        db.delete_table(u'demoscene_captchaquestion')
