...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ProductionLink.file_for_screenshot'
        db.add_column('demoscene_productionlink', 'file_for_screenshot', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ProductionLink.file_for_screenshot'
        db.delete_column('demoscene_productionlink', 'file_for_screenshot')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 9, 20, 29, 3, 378262)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 9, 20, 29, 3, 378123)'}),
