...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Production.data_source'
        db.add_column('demoscene_production', 'data_source', self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Production.data_source'
        db.delete_column('demoscene_production', 'data_source')
