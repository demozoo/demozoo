...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AccountProfile.sticky_edit_mode'
        db.delete_column(u'demoscene_accountprofile', 'sticky_edit_mode')

        # Deleting field 'AccountProfile.edit_mode_active'
        db.delete_column(u'demoscene_accountprofile', 'edit_mode_active')


    def backwards(self, orm):
        # Adding field 'AccountProfile.sticky_edit_mode'
        db.add_column(u'demoscene_accountprofile', 'sticky_edit_mode',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'AccountProfile.edit_mode_active'
        db.add_column(u'demoscene_accountprofile', 'edit_mode_active',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
