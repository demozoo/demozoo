...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AccountProfile.demozoo0_id'
        db.add_column('demoscene_accountprofile', 'demozoo0_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AccountProfile.demozoo0_id'
        db.delete_column('demoscene_accountprofile', 'demozoo0_id')
