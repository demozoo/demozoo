...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        for prodtype in orm.ProductionType.objects.all():
            prodtype.position = 0
            prodtype.save()
        # Changing field 'ProductionType.position'
        db.alter_column('demoscene_productiontype', 'position', self.gf('django.db.models.fields.IntegerField')())


    def backwards(self, orm):
        
        # Changing field 'ProductionType.position'
        db.alter_column('demoscene_productiontype', 'position', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True))
