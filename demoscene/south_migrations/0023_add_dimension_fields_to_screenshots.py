...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Screenshot.original_width'
        db.add_column('demoscene_screenshot', 'original_width', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Screenshot.original_height'
        db.add_column('demoscene_screenshot', 'original_height', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Screenshot.original_width'
        db.delete_column('demoscene_screenshot', 'original_width')

        # Deleting field 'Screenshot.original_height'
        db.delete_column('demoscene_screenshot', 'original_height')
