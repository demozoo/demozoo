...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Production.default_screenshot'
        db.add_column('demoscene_production', 'default_screenshot', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['demoscene.Screenshot']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Production.default_screenshot'
        db.delete_column('demoscene_production', 'default_screenshot_id')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 26, 22, 39, 21, 580878)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 26, 22, 39, 21, 580742)'}),
