...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('demoscene_screenshot', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('production', self.gf('django.db.models.fields.related.ForeignKey')(related_name='screenshots', to=orm['demoscene.Production'])),
            ('original', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
        ))
        db.send_create_signal('demoscene', ['Screenshot'])


    def backwards(self, orm):
        
        # Deleting model 'Screenshot'
        db.delete_table('demoscene_screenshot')
