...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Releaser', fields ['created_at']
        db.create_index('demoscene_releaser', ['created_at'])

        # Adding index on 'Releaser', fields ['updated_at']
        db.create_index('demoscene_releaser', ['updated_at'])


    def backwards(self, orm):
        
        # Removing index on 'Releaser', fields ['created_at']
        db.delete_index('demoscene_releaser', ['created_at'])

        # Removing index on 'Releaser', fields ['updated_at']
        db.delete_index('demoscene_releaser', ['updated_at'])
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 18, 18, 14, 43, 188221)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 18, 18, 14, 43, 188087)'}),
