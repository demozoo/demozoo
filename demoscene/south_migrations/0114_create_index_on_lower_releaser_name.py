...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.execute("CREATE INDEX demoscene_releaser_lower_name ON demoscene_releaser (lower(demoscene_releaser.name))")

    def backwards(self, orm):
        db.execute("DROP INDEX demoscene_releaser_lower_name")
