...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Party.homepage'
        db.alter_column('demoscene_party', 'homepage', self.gf('django.db.models.fields.URLField')(max_length=200, blank=True))


    def backwards(self, orm):
        
        # Changing field 'Party.homepage'
        db.alter_column('demoscene_party', 'homepage', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True))
