...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Production.release_date_date'
        db.add_column('demoscene_production', 'release_date_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)

        # Adding field 'Production.release_date_precision'
        db.add_column('demoscene_production', 'release_date_precision', self.gf('django.db.models.fields.CharField')(default='', max_length=1, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Production.release_date_date'
        db.delete_column('demoscene_production', 'release_date_date')

        # Deleting field 'Production.release_date_precision'
        db.delete_column('demoscene_production', 'release_date_precision')
