...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Releaser.location'
        db.add_column('demoscene_releaser', 'location', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)

        # Adding field 'Releaser.country_code'
        db.add_column('demoscene_releaser', 'country_code', self.gf('django.db.models.fields.CharField')(default='', max_length=5, blank=True), keep_default=False)

        # Adding field 'Releaser.latitude'
        db.add_column('demoscene_releaser', 'latitude', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'Releaser.longitude'
        db.add_column('demoscene_releaser', 'longitude', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'Releaser.woe_id'
        db.add_column('demoscene_releaser', 'woe_id', self.gf('django.db.models.fields.BigIntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Releaser.location'
        db.delete_column('demoscene_releaser', 'location')

        # Deleting field 'Releaser.country_code'
        db.delete_column('demoscene_releaser', 'country_code')

        # Deleting field 'Releaser.latitude'
        db.delete_column('demoscene_releaser', 'latitude')

        # Deleting field 'Releaser.longitude'
        db.delete_column('demoscene_releaser', 'longitude')

        # Deleting field 'Releaser.woe_id'
        db.delete_column('demoscene_releaser', 'woe_id')
