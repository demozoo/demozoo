...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Production.has_bonafide_edits'
        db.add_column('demoscene_production', 'has_bonafide_edits', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Production.has_bonafide_edits'
        db.delete_column('demoscene_production', 'has_bonafide_edits')
