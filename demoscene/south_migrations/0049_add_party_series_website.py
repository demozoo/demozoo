...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PartySeries.website'
        db.add_column('demoscene_partyseries', 'website', self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PartySeries.website'
        db.delete_column('demoscene_partyseries', 'website')
