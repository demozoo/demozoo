...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Platform.intro_text'
        db.add_column('demoscene_platform', 'intro_text', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Platform.intro_text'
        db.delete_column('demoscene_platform', 'intro_text')
