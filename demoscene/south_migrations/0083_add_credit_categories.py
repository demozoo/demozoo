...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Credit.category'
        db.add_column('demoscene_credit', 'category', self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Credit.category'
        db.delete_column('demoscene_credit', 'category')
