...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Releaser', fields ['is_group']
        db.create_index(u'demoscene_releaser', ['is_group'])


    def backwards(self, orm):
        # Removing index on 'Releaser', fields ['is_group']
        db.delete_index(u'demoscene_releaser', ['is_group'])
