...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SoundtrackLink'
        db.create_table('demoscene_soundtracklink', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('production', self.gf('django.db.models.fields.related.ForeignKey')(related_name='soundtrack_links', to=orm['demoscene.Production'])),
            ('soundtrack', self.gf('django.db.models.fields.related.ForeignKey')(related_name='appearances_as_soundtrack', to=orm['demoscene.Production'])),
            ('position', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('demoscene', ['SoundtrackLink'])


    def backwards(self, orm):
        
        # Deleting model 'SoundtrackLink'
        db.delete_table('demoscene_soundtracklink')
