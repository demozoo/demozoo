...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ProductionLink'
        db.create_table('demoscene_productionlink', (
            ...
            ('production', self.gf('django.db.models.fields.related.ForeignKey')(related_name='links', to=orm['demoscene.Production'])),
            ('is_download_link', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('demozoo0_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal('demoscene', ['ProductionLink'])


    def backwards(self, orm):
        
        # Deleting model 'ProductionLink'
        db.delete_table('demoscene_productionlink')
