...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Party.tagline'
        db.add_column('demoscene_party', 'tagline', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Party.tagline'
        db.delete_column('demoscene_party', 'tagline')
