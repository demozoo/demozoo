...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CompetitionPlacing'
        db.create_table('demoscene_competitionplacing', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('competition', self.gf('django.db.models.fields.related.ForeignKey')(related_name='placings', to=orm['demoscene.Competition'])),
            ('production', self.gf('django.db.models.fields.related.ForeignKey')(related_name='competition_placings', to=orm['demoscene.Production'])),
            ('ranking', self.gf('django.db.models.fields.CharField')(max_length=32, blank=True)),
            ('position', self.gf('django.db.models.fields.IntegerField')()),
            ('score', self.gf('django.db.models.fields.CharField')(max_length=32, blank=True)),
        ))
        db.send_create_signal('demoscene', ['CompetitionPlacing'])


    def backwards(self, orm):
        
        # Deleting model 'CompetitionPlacing'
        db.delete_table('demoscene_competitionplacing')
