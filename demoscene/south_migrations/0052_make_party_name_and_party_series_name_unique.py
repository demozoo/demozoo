...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'PartySeries', fields ['name']
        db.create_unique('demoscene_partyseries', ['name'])

        # Adding unique constraint on 'Party', fields ['name']
        db.create_unique('demoscene_party', ['name'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'PartySeries', fields ['name']
        db.delete_unique('demoscene_partyseries', ['name'])

        # Removing unique constraint on 'Party', fields ['name']
        db.delete_unique('demoscene_party', ['name'])
