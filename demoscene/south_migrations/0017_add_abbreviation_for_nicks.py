...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Nick.abbreviation'
        db.add_column('demoscene_nick', 'abbreviation', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Nick.abbreviation'
        db.delete_column('demoscene_nick', 'abbreviation')
