...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DownloadLink.description'
        db.add_column('demoscene_downloadlink', 'description', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)

        # Adding field 'DownloadLink.demozoo0_id'
        db.add_column('demoscene_downloadlink', 'demozoo0_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DownloadLink.description'
        db.delete_column('demoscene_downloadlink', 'description')

        # Deleting field 'DownloadLink.demozoo0_id'
        db.delete_column('demoscene_downloadlink', 'demozoo0_id')
