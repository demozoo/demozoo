...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Production.unparsed_byline'
        db.add_column('demoscene_production', 'unparsed_byline', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Production.unparsed_byline'
        db.delete_column('demoscene_production', 'unparsed_byline')
