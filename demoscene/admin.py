...
admin.site.register(
    Releaser, inlines=[NickInline, MemberOfInline, MembersInline], search_fields=["nicks__variants__name"]
)
admin.site.register(Nick, inlines=[NickVariantInline], raw_id_fields=["releaser"], search_fields=["variants__name"])
