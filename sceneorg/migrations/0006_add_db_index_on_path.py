...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Directory', fields ['path']
        db.create_index('sceneorg_directory', ['path'])

        # Adding index on 'File', fields ['path']
        db.create_index('sceneorg_file', ['path'])


    def backwards(self, orm):
        
        # Removing index on 'Directory', fields ['path']
        db.delete_index('sceneorg_directory', ['path'])

        # Removing index on 'File', fields ['path']
        db.delete_index('sceneorg_file', ['path'])
