...
def demos(request):
    ...
    csvfile.writerow(["ID", "Demozoo URL", "Title", "By", "Release date", "Type", "Nationality", "Download URL"])
    for prod in prods:
        ...
        nationalities = set([author.country_code for author in authors]).union(
            [scener.country_code for scener in credited_sceners]
        )
