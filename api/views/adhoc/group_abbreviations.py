...
def group_abbreviations(request):
    ...
    csvfile.writerow(["ID", "Demozoo URL", "Name", "Differentiator", "Abbreviation", "Other variants"])
    for nick in nicks:
        csvfile.writerow(
            [
                nick.releaser.id,
                ("https://demozoo.org" + nick.releaser.get_absolute_url()).encode("utf-8"),
