...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for am in orm.ArchiveMember.objects.values('archive_sha1', 'filename', 'file_size').annotate(count_id=models.Count('id'), min_id=models.Min('id')).filter(count_id__gt=1):
            orm.ArchiveMember.objects.filter(archive_sha1=am['archive_sha1'], filename=am['filename'], file_size=am['file_size'], id__gt=am['min_id']).delete()
