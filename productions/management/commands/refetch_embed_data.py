...
from common.utils.groklinks import EMBEDDABLE_PRODUCTION_LINK_TYPES
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        prod_links = (
            ProductionLink.objects.filter(link_class__in=link_types)
            .exclude(embed_data_last_fetch_time__gt=last_month)
            .exclude(embed_data_last_error_time__gt=last_month)
