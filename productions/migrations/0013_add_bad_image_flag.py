...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProductionLink.has_bad_image'
        db.add_column(u'productions_productionlink', 'has_bad_image',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProductionLink.has_bad_image'
        db.delete_column(u'productions_productionlink', 'has_bad_image')
