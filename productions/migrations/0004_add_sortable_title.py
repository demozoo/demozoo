...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Production.sortable_title'
        db.add_column(u'productions_production', 'sortable_title',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Production.sortable_title'
        db.delete_column(u'productions_production', 'sortable_title')
    ...
    models = {
        ...
        u'productions.production': {
            ...
            'sortable_title': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
