...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ProductionLink.video_width'
        db.add_column(u'productions_productionlink', 'video_width',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ProductionLink.video_height'
        db.add_column(u'productions_productionlink', 'video_height',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ProductionLink.video_width'
        db.delete_column(u'productions_productionlink', 'video_width')

        # Deleting field 'ProductionLink.video_height'
        db.delete_column(u'productions_productionlink', 'video_height')
