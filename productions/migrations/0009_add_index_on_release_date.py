...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Production', fields ['release_date_date', 'created_at']
        db.create_index(u'productions_production', ['release_date_date', 'created_at'])


    def backwards(self, orm):
        # Removing index on 'Production', fields ['release_date_date', 'created_at']
        db.delete_index(u'productions_production', ['release_date_date', 'created_at'])
