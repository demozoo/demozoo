...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'ProductionLink', fields ['link_class', 'parameter']
        db.create_index(u'productions_productionlink', ['link_class', 'parameter'])


    def backwards(self, orm):
        # Removing index on 'ProductionLink', fields ['link_class', 'parameter']
        db.delete_index(u'productions_productionlink', ['link_class', 'parameter'])
