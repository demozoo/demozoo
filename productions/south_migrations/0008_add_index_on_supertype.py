...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Production', fields ['supertype']
        db.create_index(u'productions_production', ['supertype'])


    def backwards(self, orm):
        # Removing index on 'Production', fields ['supertype']
        db.delete_index(u'productions_production', ['supertype'])
    ...
    models = {
        ...
        u'productions.production': {
            'Meta': {'ordering': "['sortable_title']", 'object_name': 'Production'},
