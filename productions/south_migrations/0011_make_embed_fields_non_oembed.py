...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column(u'productions_productionlink', 'oembed_thumbnail_url', 'thumbnail_url')
        db.rename_column(u'productions_productionlink', 'oembed_thumbnail_width', 'thumbnail_width')
        db.rename_column(u'productions_productionlink', 'oembed_thumbnail_height', 'thumbnail_height')
        db.rename_column(u'productions_productionlink', 'oembed_last_fetch_time', 'embed_data_last_fetch_time')
        db.rename_column(u'productions_productionlink', 'oembed_last_error_time', 'embed_data_last_error_time')

    def backwards(self, orm):
        db.rename_column(u'productions_productionlink', 'thumbnail_url', 'oembed_thumbnail_url')
        db.rename_column(u'productions_productionlink', 'thumbnail_width', 'oembed_thumbnail_width')
        db.rename_column(u'productions_productionlink', 'thumbnail_height', 'oembed_thumbnail_height')
        db.rename_column(u'productions_productionlink', 'embed_data_last_fetch_time', 'oembed_last_fetch_time')
        db.rename_column(u'productions_productionlink', 'embed_data_last_error_time', 'oembed_last_error_time')
    ...
    models = {
        ...
        u'productions.productionlink': {
            ...
            'embed_data_last_error_time': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'embed_data_last_fetch_time': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
