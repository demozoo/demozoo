...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Ansi'
        db.create_table(u'productions_ansi', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('production', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ansis', to=orm['productions.Production'])),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=255)),
        ))
        db.send_create_signal(u'productions', ['Ansi'])


    def backwards(self, orm):
        # Deleting model 'Ansi'
        db.delete_table(u'productions_ansi')
    ...
    models = {
        ...
        u'productions.ansi': {
            'Meta': {'object_name': 'Ansi'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'production': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'ansis'", 'to': u"orm['productions.Production']"}),
        ...
        u'productions.productionlink': {
            ...
            'has_bad_image': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
