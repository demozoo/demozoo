...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.execute("CREATE INDEX demoscene_production_coalesced_date ON productions_production (coalesce(productions_production.release_date_date, '1970-01-01'), title)")

    def backwards(self, orm):
        db.execute("DROP INDEX demoscene_production_coalesced_date")
