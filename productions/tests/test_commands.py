...
class TestFetchEmbedData(TestCase):
    ...
    def test_run(self, fetch_production_link_embed_data):
        ...
        link = pondlife.links.create(link_class="SpeccyWikiPage", parameter="1lFBXWxSrKE", is_download_link=False)
...
class TestMirrorMusicFiles(TestCase):
    ...
    def test_run(self, sleep, upload_to_s3):
        ...
        cybrev.links.create(link_class="BaseUrl", parameter="http://example.com/cybrev.mod", is_download_link=True)
        ...
        self.assertTrue(
            cybrev.links.filter(
                link_class="BaseUrl", parameter="https://media.demozoo.org/music/cybrev.mod", is_download_link=True
            ).exists()
        )
    ...
    def test_already_playable(self, sleep, upload_to_s3):
        cybrev = Production.objects.get(title="Cybernoid's Revenge")
        cybrev.links.create(
            link_class="BaseUrl", parameter="https://files.zxdemo.org/cybrev.stc", is_download_link=True
        )
        cybrev.links.create(link_class="BaseUrl", parameter="http://example.com/cybrev.mod", is_download_link=True)
        upload_to_s3.return_value = "https://media.demozoo.org/music/cybrev.mod"
    ...
    def test_oversized(self, sleep, upload_to_s3):
        cybrev = Production.objects.get(title="Cybernoid's Revenge")
        cybrev.links.create(
            link_class="BaseUrl", parameter="http://example.com/pretend-big-file.mod", is_download_link=True
        )
        upload_to_s3.return_value = "https://media.demozoo.org/music/cybrev.mod"
...
class TestFindEmulatableZxdemoProds(TestCase):
    ...
    def test_run(self):
        ...
        pondlife.links.create(
            link_class="BaseUrl", parameter="https://files.zxdemo.org/pondlife2.txt", is_download_link=True
        )
        pondlife.links.create(
            link_class="BaseUrl", parameter="https://files.zxdemo.org/zxwister.zip", is_download_link=True
        )
        pondlife.links.create(
            link_class="BaseUrl", parameter="https://files.zxdemo.org/badzipfile.zip", is_download_link=True
        )
        pondlife.links.create(
            link_class="BaseUrl", parameter="https://files.zxdemo.org/brokenlink.zip", is_download_link=True
        )

        responses.add(responses.GET, "https://files.zxdemo.org/pondlife2.txt", body="just a text file")
        responses.add(
            responses.GET,
            "https://files.zxdemo.org/badzipfile.zip",
        ...
        responses.add(responses.GET, "https://files.zxdemo.org/zxwister.zip", body=zxwister)
...
class TestFindEmulatableNonZxdemoProds(TestCase):
    ...
    def test_run_link_without_emulatable_file(self, upload_to_s3, Session, sleep):
        pondlife = Production.objects.get(title="Pondlife")
        pondlife.links.create(link_class="PouetProduction", parameter="1234", is_download_link=False)
        pondlife.links.create(link_class="BaseUrl", parameter="http://example.com/pondlife2.txt", is_download_link=True)
        pondlife.links.create(
            link_class="BaseUrl", parameter="http://example.com/real-big-file.txt", is_download_link=True
        )
        pondlife.links.create(link_class="BaseUrl", parameter="http://example.com/rubber.zip", is_download_link=True)
    ...
    def test_run_link_with_bad_zipfile(self, upload_to_s3, Session, sleep):
        pondlife = Production.objects.get(title="Pondlife")
        pondlife.links.create(
            link_class="BaseUrl", parameter="http://example.com/badzipfile.zip", is_download_link=True
        )
    ...
    def test_run_link_with_emulatable_file_in_zip(self, upload_to_s3, Session, sleep):
        ...
        pondlife.links.create(link_class="BaseUrl", parameter="http://example.com/pondlife2.txt", is_download_link=True)
        pondlife.links.create(
            link_class="BaseUrl", parameter="http://example.com/badtapfile.tap", is_download_link=True
        )
        pondlife.links.create(link_class="BaseUrl", parameter="http://example.com/zxwister.zip", is_download_link=True)
    ...
    def test_run_link_with_multiple_emulatable_files_in_zip(self, upload_to_s3, Session, sleep):
        pondlife = Production.objects.get(title="Pondlife")
        pondlife.links.create(link_class="BaseUrl", parameter="http://example.com/zxwister2.zip", is_download_link=True)
    ...
    def test_run_link_with_emulatable_file_not_in_zip(self, upload_to_s3, Session, sleep):
        pondlife = Production.objects.get(title="Pondlife")
        pondlife.links.create(link_class="BaseUrl", parameter="http://example.com/pondlife.tap", is_download_link=True)
