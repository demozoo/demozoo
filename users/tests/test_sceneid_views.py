...
class TestLogin(TestCase):
    ...
    def test_login_new_user(self, get_random_string):
        ...
        response = self.client.post(
            "/account/sceneid/connect/",
            {"accountNew": "Register new account", "username": "newuser", "email": "newuser@example.com"},
        )
    ...
    def test_login_connect_user(self, get_random_string):
        ...
        response = self.client.post(
            "/account/sceneid/connect/", {"accountExisting": "Log in", "username": "testuser", "password": "12345"}
        )
        self.assertRedirects(response, "/")
        logged_in_user = auth.get_user(self.client)
    ...
    def test_login_connect_user_bad_login(self, get_random_string):
        ...
        # log in to testuser account
        response = self.client.post(
            "/account/sceneid/connect/", {"accountExisting": "Log in", "username": "testuser", "password": "12346"}
        )
