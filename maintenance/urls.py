...
urlpatterns = patterns('maintenance.views',
	...
	(r'^prods_without_platforms_excluding_lost$', 'prods_without_platforms_excluding_lost', {}, 'maintenance_prods_without_platforms_excluding_lost'),
	(r'^prods_without_platforms_with_downloads$', 'prods_without_platforms_with_downloads', {}, 'maintenance_prods_without_platforms_with_downloads'),
