...
class TestFetchRemoteScreenshots(TestCase):
    ...
    def setUp(self):
        ...
        self.link = skyrider.links.create(
            link_class="BaseUrl", parameter="http://example.com/skyrider.scr", is_download_link=True
        )
...
class TestFetchRemoteZippedScreenshots(TestCase):
    ...
    def test_run_new(self, create_screenshot_from_production_link):
        ...
        link = self.skyrider.links.create(
            link_class="BaseUrl", parameter="http://example.com/skyrider.zip", is_download_link=True
        )
    ...
    def test_ignore_non_zip(self, create_screenshot_from_production_link):
        ...
        self.skyrider.links.create(
            link_class="BaseUrl", parameter="http://example.com/skyrider.rar", is_download_link=True
        )
    ...
    def test_ignore_known_too_big(self, create_screenshot_from_production_link):
        ...
        Download.objects.create(
            ...
            downloaded_at=datetime.date(2020, 6, 1),
            error_type="FileTooBig",
        )
    ...
    def test_good_file_for_screenshot(self, create_screenshot_from_production_link):
        ...
        link = self.skyrider.links.create(
            ...
            file_for_screenshot="skyrider.scr",
        )
    ...
    def test_bad_file_for_screenshot(self, create_screenshot_from_production_link):
        ...
        self.skyrider.links.create(
            ...
            parameter="http://example.com/skyrider.zip",
            is_download_link=True,
            file_for_screenshot="skyrider.tap",
        )
    ...
    def test_select_archive_member(self, create_screenshot_from_production_link):
        ...
        ArchiveMember.objects.create(archive_sha1="012345678", filename="skyrider.nfo", file_size=100)
        ArchiveMember.objects.create(archive_sha1="012345678", filename="skyrider.scr", file_size=6912)
    ...
    def test_unresolved_archive_member(self, create_screenshot_from_production_link):
        ...
        ArchiveMember.objects.create(archive_sha1="012345678", filename="skyrider.nfo", file_size=100)
        ArchiveMember.objects.create(archive_sha1="012345678", filename="skyrider.scr", file_size=6912)
        ArchiveMember.objects.create(archive_sha1="012345678", filename="skyrider-alt.scr", file_size=6912)
