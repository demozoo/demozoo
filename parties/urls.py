...
urlpatterns = [
    ...
    re_path(
        r"^parties/series/(\d+)/edit_external_links/$",
    ...
    re_path(
        r"^parties/(\d+)/remove_organiser/(\d+)/$",
    ...
    re_path(
        r"^competitions/(\d+)/delete/$", competition_views.DeleteCompetitionView.as_view(), {}, "delete_competition"
    ),
