...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field releases on 'Party'
        m2m_table_name = db.shorten_name(u'parties_party_releases')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('party', models.ForeignKey(orm[u'parties.party'], null=False)),
            ('production', models.ForeignKey(orm[u'productions.production'], null=False))
        ))
        db.create_unique(m2m_table_name, ['party_id', 'production_id'])


    def backwards(self, orm):

        # Removing M2M table for field releases on 'Party'
        db.delete_table(db.shorten_name(u'parties_party_releases'))
