...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        db.execute("""
            UPDATE parties_party SET notes = REPLACE(notes, 'http://dev.demozoo.org', 'http://demozoo.org')
            WHERE notes LIKE '%%http://dev.demozoo.org%%'
        """)
        db.execute("""
            UPDATE parties_partyseries SET notes = REPLACE(notes, 'http://dev.demozoo.org', 'http://demozoo.org')
            WHERE notes LIKE '%%http://dev.demozoo.org%%'
        """)
