...
from parties.models import Competition, Party, PartySeries
...
class TestParty(TestCase):
    ...
    def test_default_competition_date(self):
        ...
        self.assertEqual(forever_longparty.default_competition_date(), FuzzyDate(datetime.date(2020, 5, 15), "d"))
        ...
        self.assertEqual(forever_futureparty.default_competition_date(), FuzzyDate(datetime.date(2020, 5, 17), "d"))
        ...
        self.assertEqual(forever_fuzzyparty.default_competition_date(), FuzzyDate(datetime.date(2020, 3, 1), "m"))

    def test_sceneorg_results_file(self):
        forever = Party.objects.get(name="Forever 2e3")
        forever.external_links.create(link_class="SceneOrgFolder", parameter="/parties/2000/forever00/")
    ...
    def test_share_image_url(self):
        ...
        screenshot = pondlife.screenshots.create(
            thumbnail_url="http://example.com/pondlife.thumb.png",
            thumbnail_width=130,
            thumbnail_height=100,
            standard_url="http://example.com/pondlife.standard.png",
            standard_width=400,
            standard_height=300,
        )
...
class TestCompetition(TestCase):
    ...
    def test_string(self):
        competition = Competition(name="Demo")
        self.assertEqual(competition.suffixed_name, "Demo competition")
        competition = Competition(name="Music showcase")
        self.assertEqual(competition.suffixed_name, "Music showcase")
