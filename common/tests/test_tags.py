...
then it's
    ...
    def test_link_types(self):
        ...
        self.assertEqual(
            safe_markdown('Here is a <a href="/local/">link</a>'), '<p>Here is a <a href="/local/">link</a></p>'
        )
        self.assertEqual(
            safe_markdown('Here is a <a href="#anchor">link</a>'), '<p>Here is a <a href="#anchor">link</a></p>'
        )
        self.assertEqual(
            safe_markdown('Here is a <a href="smb://example.com/warez">link</a>'), "<p>Here is a <a>link</a></p>"
        )
