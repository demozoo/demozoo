...
COMMON_BUTTON_KWARGS = ["icon", "classname", "lightbox", "focus_empty", "title", "nofollow", "label", "onClick"]
...
@register.inclusion_tag("tags/text_to_clipboard.html")
def text_to_clipboard(text, **kwargs):
    context = {"text":text}
    return context
