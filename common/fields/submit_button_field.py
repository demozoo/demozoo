...
class SubmitButtonInput(forms.Widget):
    ...
    def render(self, name, value, attrs=None, renderer=None):
        ...
        final_attrs = self.build_attrs(self.attrs, dict(type="submit", name=name, value=self.button_text, **attrs))
...
class SubmitButtonField(forms.Field):
    ...
    def __init__(
        self, button_text=None, required=True, widget=None, label=None, initial=None, help_text=None, *args, **kwargs
    ):
        super().__init__(
