...
def add_banner(request):
    ...
    return render(
        request,
        "homepage/banners/add_banner.html",
        {"form": form, "image_form": BannerImageForm(prefix="bannerimageform")},
    )
...
def edit_banner(request, banner_id):
    ...
    return render(
        request,
        "homepage/banners/edit_banner.html",
        {"banner": banner, "form": form, "image_form": BannerImageForm(prefix="bannerimageform")},
    )
