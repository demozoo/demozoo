...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'homepage_bannerimage', (
        ...
        db.send_create_signal(u'homepage', ['BannerImage'])

        # Adding field 'Banner.banner_image'
        db.add_column(u'homepage_banner', 'banner_image',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, on_delete=models.SET_NULL, to=orm['homepage.BannerImage']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'BannerImage'
        db.delete_table(u'homepage_bannerimage')

        # Deleting field 'Banner.banner_image'
        db.delete_column(u'homepage_banner', 'banner_image_id')
