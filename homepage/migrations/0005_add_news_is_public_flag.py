...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NewsStory.is_public'
        db.add_column(u'homepage_newsstory', 'is_public',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NewsStory.is_public'
        db.delete_column(u'homepage_newsstory', 'is_public')
