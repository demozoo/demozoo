...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'NewsStory'
        db.create_table('homepage_newsstory', (
        ...
        db.send_create_signal('homepage', ['NewsStory'])


    def backwards(self, orm):
        
        # Deleting model 'NewsStory'
        db.delete_table('homepage_newsstory')
