...
class TestBannerImageModel(TestCase):
    def setUp(self):
        self.banner_image = BannerImage.objects.create(image=get_test_image(), image_url="http://example.com/test.png")
...
class TestNewsImageModel(TestCase):
    def setUp(self):
        self.news_image = NewsImage.objects.create(image=get_test_image(), image_url="http://example.com/test.png")
